        ...
        <b-navbar toggleable="lg" variant="transparent">
            ...
            <b-collapse id="nav-collapse" is-nav>
                <b-navbar-nav id="nav-items">
                    ...
                    <b-nav-item-dropdown class="nav-item" text="Create Account">
                        <b-dropdown-item to="/CreateClient" exact exact-active-class="active">Create Client</b-dropdown-item>
                        <b-dropdown-item to="/CreateLib" exact exact-active-class="active">Create Librarian</b-dropdown-item>
                    </b-nav-item-dropdown>
